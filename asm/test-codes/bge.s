...
test02:
  ...
  li x1, 0x00000001
  li x2, 0x00000001
  bge x1, x2, label2_test02
  bne x0, a1, fail
label1_test02:
  bne x0, a1, label3_test02
label2_test02:
  bge x1, x2, label1_test02
  bne x0, a1, fail
label3_test02:
...
test03:
  ...
  li x1, 0xffffffff
  li x2, 0xffffffff
  bge x1, x2, label2_test03
  bne x0, a1, fail
label1_test03:
  bne x0, a1, label3_test03
label2_test03:
  bge x1, x2, label1_test03
  bne x0, a1, fail
label3_test03:
...
test04:
  ...
  li x1, 0x00000001
  li x2, 0x00000000
  bge x1, x2, label2_test04
  bne x0, a1, fail
label1_test04:
  bne x0, a1, label3_test04
label2_test04:
  bge x1, x2, label1_test04
  bne x0, a1, fail
label3_test04:
...
test05:
  ...
  li x1, 0x00000001
  li x2, 0xffffffff
  bge x1, x2, label2_test05
  bne x0, a1, fail
label1_test05:
  bne x0, a1, label3_test05
label2_test05:
  bge x1, x2, label1_test05
  bne x0, a1, fail
label3_test05:
...
test06:
  ...
  li x1, 0xffffffff
  li x2, 0xfffffffe
  bge x1, x2, label2_test06
  bne x0, a1, fail
label1_test06:
  bne x0, a1, label3_test06
label2_test06:
  bge x1, x2, label1_test06
  bne x0, a1, fail
label3_test06:
